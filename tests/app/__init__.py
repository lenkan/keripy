...
def openMultiSig(prefix="test", salt=b'0123456789abcdef', temp=True, **kwa):
    with (habbing.openHab(name=f"{prefix}_1", salt=salt, transferable=True, temp=temp) as (hby1, hab1),
        ...
        yield create_group_triple(members, inits, prefix)

def create_group_triple(members, inits, prefix):
    [(hby1, hab1), (hby2, hab2), (hby3, hab3)] = members
    ...
    return (hby1, ghab1), (hby2, ghab2), (hby3, ghab3)
